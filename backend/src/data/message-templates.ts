...
export const messageTemplates: Record<string, MessageTemplate[]> = {
  ...
  WELCOME: [
    ...
    },
    {
      ...
      category: "WELCOME",
      channel: "SMS",
      content: "{{firstName}}, you're in. Your first week is built. Show up and follow the plan.",
      cooldownHours: 720,
      tags: ["onboarding", "first-message"],
    },
    {
    ...
    },
    {
      ...
      category: "WELCOME",
      channel: "SMS",
      content: "{{firstName}}, the foundation is laid. Your plan is personalized, adaptive, and ready to go. Stay disciplined. Stay dominant.",
      cooldownHours: 720,
      tags: ["onboarding", "first-message"],
    },
    {
